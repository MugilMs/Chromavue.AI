...
const SignIn = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Simulate authentication process with success message
    setTimeout(() => {
      setIsLoading(false);
      // Show success message and redirect in a real app
      alert("Sign in successful! Welcome to your Chromavue.AI dashboard.");
      ...
      <header className="bg-white shadow-sm p-4">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <nav className="hidden md:flex items-center gap-4">
            ...
            <Link to="/signin" className="text-gray-600 hover:text-blue-600 font-medium">Sign In</Link>
          </nav>
        </div>
      </header>
      ...
      <div className="flex-grow flex items-center justify-center px-4 py-12">
        <div className="bg-white rounded-xl shadow-xl p-8 w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 mt-2">Sign in to your Chromavue.AI account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <Button
                type="submit"
                disabled={isLoading}
                className="w-full py-2 px-4 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-medium rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
              >
          ...
          <p className="mt-8 text-center text-sm text-gray-600">
            ...
            <Link to="/signup" className="font-medium text-blue-600 hover:text-blue-500">
              Sign up <ArrowRight className="inline-block h-3 w-3" />
            </Link>
          </p>
        </div>
      </div>
